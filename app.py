...
# Home Page
if selected == "Home":
    st.title("Food & Calories Measurment Detection")
    st.write("Upload an image to detect food and calories.")
    ...
    if upload:
        ...
        if detections:
            ...
            st.write("No food and calories detected.")

# About Page
elif selected == "About":
    st.title("About")
    st.write("""
    This application detects Food & Calories Measurment using a YOLO model and CNN. 
